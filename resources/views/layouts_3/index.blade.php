    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#language">Bahasa</a></li>
            </ul>
        </div>
    </nav>
    <!-- Page Content-->
    <div class="container-fluid p-0">
        ...
        <section class="resume-section" id="about">
            <div class="resume-section-content">
                ...
                <div class="subheading mb-5">
                    {{ $profile->alamat }} · (+62) {{ $profile->no_telpon }} ·
                ...
                @foreach ($experience as $index => $item)
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            ...
                            <div class="subheading mb-3">{{ $item->sub_judul }}</div>
                            <p>{{ $item->deskripsi }}</p>
                        </div>
                        <div class="flex-shrink-0"><span class="text-primary">
                                @php
                                    echo date('d M Y', strtotime($item->awal_kerja));
                                    echo ' - ';
                                    echo date('d M Y', strtotime($item->akhir_kerja));
                                @endphp
        ...
        <section class="resume-section" id="education">
            <div class="resume-section-content">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                    <div class="flex-grow-1">
                        <h3 class="mb-0">{{ $item->nama_sekolah }}</h3>
                        <div class="subheading mb-3">{{ $item->jurusan }}</div>
                        <p>{{ $item->deskripsi }}</p>
                    </div>
                    <div class="flex-shrink-0"><span class="text-primary">
                            @php
                                echo date('d M Y', strtotime($item->riwayat_pendidikan));
        ...
        <section class="resume-section" id="skill">
            <div class="resume-section-content">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                    <div class="flex-grow-1">
                        <h3 class="mb-0">{{ $item->nama_skill }}</h3>
                        <div class="subheading mb-3">{{ $item->sub_judul }}</div>
        ...
        <section class="resume-section" id="awards">
            <div class="resume-section-content">
                <h2 class="mb-5">Penghargaan</h2>
                @foreach ( $awards as $index => $item )
                <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                    <div class="flex-grow-1">
                        <h3 class="mb-0">{{ $item->nama_penghargaan }}</h3>
                        <div class="subheading mb-3">{{ $item->tahun_penghargaan }}</div>
                        <p>{{ $item->deskripsi }}</p>
                    </div>
                    <div class="flex-shrink-0"><span class="text-primary">
                        @php
                            echo date('d M Y', strtotime($item->tahun_penghargaan));
        ...
        <section class="resume-section" id="language">
            <div class="resume-section-content">
                <h2 class="mb-5">Bahasa</h2>
                @foreach ( $language as $index => $item )
                <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                    <div class="flex-grow-1">
                        <h3 class="mb-0">{{ $item->nama_bahasa }}</h3>
                        <div class="subheading mb-3">{{ $item->tingkat_bahasa }}</div>
                        <p>{{ $item->deskripsi }}</p>
                    </div>
                    <div class="flex-shrink-0"><span class="text-primary">
                @endforeach
