...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <a href="{{ route('language.create') }}" class="btn btn-primary btn-sm mb-2">ADD</a>
            <a href="{{ url('admin/language/recycle') }}" class="btn btn-warning btn-sm mb-2">Recycle</a>
                        ...
                        @foreach ($language as $index => $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('language.softdelete', $item->id) }}" method="POST"
