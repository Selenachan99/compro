...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <a href="{{ route('awards.create') }}" class="btn btn-primary btn-sm mb-2">ADD</a>
            <a href="{{ url('admin/awards/recycle') }}" class="btn btn-warning btn-sm mb-2">Recycle</a>
                        ...
                        @foreach ($awards as $index => $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('awards.softdelete', $item->id) }}" method="POST"
