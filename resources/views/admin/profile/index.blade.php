...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <a href="{{ url('admin/profiles/recycle') }}" class="btn btn-warning btn-sm mb-2">Recycle</a>
                        ...
                        @foreach ($profiles as $index => $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('profiles.softdelete', $item->id) }}" method="POST"
                                    ...
                                    <a href="{{route('generate-pdf', $item->id)}}" class="btn btn-primary btn-sm">Print</a>
                                </td>
                                ...
                                <td><img src="{{ asset('storage/image/' . $item->picture) }}" alt=""
                                        width="150px ">
                                </td>
                            </tr>
                        @endforeach
